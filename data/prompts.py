...
QA_PROMPT_PREFIX = """Your task is to add calls to a Question Answering API to a piece of text.
...
CALCULATOR_PROMPT_PREFIX = """Your task is to add calls to a
...
WIKISEARCH_PROMPT_PREFIX = """Your task is to complete a given piece
...
MT_PROMPT_PREFIX = """Your task is to complete a given piece
...
CALENDAR_PROMPT_PREFIX = """Your task is to add calls to a Calendar
